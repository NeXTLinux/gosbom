...
func toGosbomCoordinates(f *spdx.File) file.Coordinates {
...
func toGosbomLocation(f *spdx.File) *file.Location {
	l := file.NewVirtualLocationFromCoordinates(toGosbomCoordinates(f), f.FileName)
	return &l
}
