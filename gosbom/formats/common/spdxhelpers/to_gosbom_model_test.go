...
func TestExtractSourceFromNamespaces(t *testing.T) {
	tests := []struct {
		...
		{
			namespace: "https://anchore.com/gosbom/image/d42b01d0-7325-409b-b03f-74082935c4d3",
			expected:  source.ImageScheme,
		},
		{
			namespace: "https://anchore.com/gosbom/dir/d42b01d0-7325-409b-b03f-74082935c4d3",
