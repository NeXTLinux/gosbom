...
func prependZipSourceFixtureWithString(tb testing.TB, value string) func(tb testing.TB) string {
	...
	return func(t testing.TB) string {
		...
		// create a temp file
		tmpFile, err := os.CreateTemp(tb.TempDir(), "gosbom-ziputil-prependZipSourceFixtureWithString-")
		if err != nil {
...
func prepZipSourceFixture(t testing.TB) string {
	t.Helper()
	archivePrefix := path.Join(t.TempDir(), "gosbom-ziputil-prepZipSourceFixture-")
